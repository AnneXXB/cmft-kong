...
build = {
  ...
  modules = {
    ...
    ["kong.resty.redis_cluster"] = "kong/resty/redis_cluster.lua",
    ...
    ["kong.plugins.role-route.migrations"] = "kong/plugins/role-route/migrations/init.lua",
    ["kong.plugins.role-route.migrations.000_base_role_route"] = "kong/plugins/role-route/migrations/000_base_role_route.lua",
    ["kong.plugins.role-route.handler"] = "kong/plugins/role-route/handler.lua",
    ["kong.plugins.role-route.schema"] = "kong/plugins/role-route/schema.lua",
    ["kong.plugins.role-route.api"] = "kong/plugins/role-route/api.lua",
    ["kong.plugins.role-route.daos"] = "kong/plugins/role-route/daos.lua",

	["kong.plugins.nucplugin.handler"] = "kong/plugins/nucplugin/handler.lua",
    ["kong.plugins.nucplugin.schema"] = "kong/plugins/nucplugin/schema.lua",
    ["kong.plugins.nucplugin.api"] = "kong/plugins/nucplugin/api.lua",
    ["kong.plugins.nucplugin.exporter"] = "kong/plugins/nucplugin/exporter.lua",
    ...
    ["kong.plugins.default-route.migrations"] = "kong/plugins/default-route/migrations/init.lua",
    ["kong.plugins.default-route.migrations.000_base_default_route"] = "kong/plugins/default-route/migrations/000_base_default_route.lua",
    ["kong.plugins.default-route.handler"] = "kong/plugins/default-route/handler.lua",
    ["kong.plugins.default-route.schema"] = "kong/plugins/default-route/schema.lua",
    ["kong.plugins.default-route.api"] = "kong/plugins/default-route/api.lua",
    ["kong.plugins.default-route.daos"] = "kong/plugins/default-route/daos.lua",

    ["kong.plugins.weight-route.migrations"] = "kong/plugins/weight-route/migrations/init.lua",
    ["kong.plugins.weight-route.migrations.000_base_weight_route"] = "kong/plugins/weight-route/migrations/000_base_weight_route.lua",
    ["kong.plugins.weight-route.handler"] = "kong/plugins/weight-route/handler.lua",
    ["kong.plugins.weight-route.schema"] = "kong/plugins/weight-route/schema.lua",
    ["kong.plugins.weight-route.api"] = "kong/plugins/weight-route/api.lua",
    ["kong.plugins.weight-route.daos"] = "kong/plugins/weight-route/daos.lua",


    ["kong.plugins.version-route.migrations"] = "kong/plugins/version-route/migrations/init.lua",
    ["kong.plugins.version-route.migrations.000_base_version_route"] = "kong/plugins/version-route/migrations/000_base_version_route.lua",
    ["kong.plugins.version-route.handler"] = "kong/plugins/version-route/handler.lua",
    ["kong.plugins.version-route.schema"] = "kong/plugins/version-route/schema.lua",
    ["kong.plugins.version-route.api"] = "kong/plugins/version-route/api.lua",
    ["kong.plugins.version-route.daos"] = "kong/plugins/version-route/daos.lua",

    ["kong.plugins.identity-auth.migrations"] = "kong/plugins/identity-auth/migrations/init.lua",
    ["kong.plugins.identity-auth.migrations.000_base_identity_auth"] = "kong/plugins/identity-auth/migrations/000_base_identity_auth.lua",
    ["kong.plugins.identity-auth.handler"] = "kong/plugins/identity-auth/handler.lua",
    ["kong.plugins.identity-auth.schema"] = "kong/plugins/identity-auth/schema.lua",
    ["kong.plugins.identity-auth.cache"] = "kong/plugins/identity-auth/cache.lua",
    ["kong.plugins.identity-auth.nuc"] = "kong/plugins/identity-auth/nuc.lua",
    ["kong.plugins.identity-auth.JSON"] = "kong/plugins/identity-auth/JSON.lua",
    ["kong.plugins.identity-auth.daos"] = "kong/plugins/identity-auth/daos.lua",
    ["kong.plugins.identity-auth.api"] = "kong/plugins/identity-auth/api.lua",
    ["kong.plugins.identity-auth.vault"] = "kong/plugins/identity-auth/vault.lua",

    ["kong.plugins.device-auth.migrations"] = "kong/plugins/device-auth/migrations/init.lua",
    ["kong.plugins.device-auth.migrations.000_base_device_auth"] = "kong/plugins/device-auth/migrations/000_base_device_auth.lua",
    ["kong.plugins.device-auth.handler"] = "kong/plugins/device-auth/handler.lua",
    ["kong.plugins.device-auth.schema"] = "kong/plugins/device-auth/schema.lua",
    ["kong.plugins.device-auth.daos"] = "kong/plugins/device-auth/daos.lua",
    ["kong.plugins.device-auth.api"] = "kong/plugins/device-auth/api.lua",

    ["kong.plugins.link-filter.handler"] = "kong/plugins/link-filter/handler.lua",
    ["kong.plugins.link-filter.schema"] = "kong/plugins/link-filter/schema.lua",
    ["kong.plugins.link-filter.regex"] = "kong/plugins/link-filter/regex.lua",
  }
}
